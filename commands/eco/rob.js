...
module.exports = {
  name: "rob",
  description: `to rob ppl money`,
  aliases: [],
  cooldown: 3,
  edesc: `to rob ppl money Usage: ${PREFIX}rob <@user> `,
  async execute(message, args, client) {
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
      ...
      let moneyEmbed = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`<:Cross:618736602901905418> You need atleast 800 coins in your wallet to rob someone`);
      ...
      if (vip === true) random = Math.floor(Math.random() * 2000) + 1;
      if (vip === null) random = Math.floor(Math.random() * 900) + 1;
