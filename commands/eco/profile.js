...
module.exports = {
  name: "profile",
  description: `to get your profile`,
  aliases: ["prof"],
  cooldown: 3,
  edesc: `to get your profile Usage: ${PREFIX}profile or <@user>`,
  async execute(message, args, client) {
    ...
    let newdrip = await db.fetch(`drip_${message.guild.id}_${user.id}`)
    if (newdrip === null) newdrip = '0'
