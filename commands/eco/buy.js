...
module.exports = {
    ...
    aliases: [],
    cooldown: 3,
    edesc: `to buy from store Usage: ${PREFIX}buy <item>`,
    async execute(message, args, client) {
        ...
        let Embed = new Discord.MessageEmbed()
            .setColor("#FFFFFF")
            .setDescription(`<:x:618736602901905418> You need 2000 coins to purchase Bronze VIP`);
        ...
        if (args[0] == 'bronze') {
            ...
            let Embed2 = new Discord.MessageEmbed()
                .setColor("#FFFFFF")
                .setDescription(`<:Cross:618736602901905418> You need 20000 coins to purchase a Mansion`);

            if (author < 20000) return message.channel.send(Embed2)

            db.fetch(`drip_${message.guild.id}_${user.id}`)
            db.add(`drip_${message.guild.id}_${user.id}`, 1)

            let Embed3 = new Discord.MessageEmbed()
                .setColor("#FFFFFF")
                .setDescription(`<:Check:618736570337591296> Purchased a Mansion For 20000 Coins`);
